...
class MapRenderer {
 public:
  MapRenderer() {
    map_shader.use();
    unsigned int modelLoc = glGetUniformLocation(map_shader.ID, "model");
    glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
    unsigned int orthoLoc = glGetUniformLocation(map_shader.ID, "ortho");
 ...
 private:
  ...
  Shader map_shader{Shader("../shaders/map.glsl", true, true)};
